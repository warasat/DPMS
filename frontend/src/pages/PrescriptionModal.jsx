...
//           <p><strong>Description:</strong> {prescriptionData.description}</p>
//           <p><strong>Medicine 1:</strong> {prescriptionData.medicineDetails.medicine1}</p>
//           <p><strong>Medicine 2:</strong> {prescriptionData.medicineDetails.medicine2}</p>
//           <p><strong>Medicine 3:</strong> {prescriptionData.medicineDetails.medicine3}</p>
//           <p><strong>Doctor Name:</strong> {prescriptionData.doctorDetails.name}</p>
//           <p><strong>Doctor Age:</strong> {prescriptionData.doctorDetails.age}</p>
//           <p><strong>Patient Name:</strong> {prescriptionData.patientDetails.name}</p>
//           <p><strong>Patient Age:</strong> {prescriptionData.patientDetails.age}</p>
//         </div>
//       ) : (
